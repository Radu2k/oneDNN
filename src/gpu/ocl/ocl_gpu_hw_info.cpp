...
void init_gpu_hw_info(cl_device_id device, cl_context context,
    ...
    switch (hw) {
        ...
        case HW::Xe_LP: gpu_arch = compute::gpu_arch_t::xe_lp; break;
#if DNNL_WITH_XE_HP
        case HW::Xe_HP: gpu_arch = compute::gpu_arch_t::xe_hp; break;
#endif
#if DNNL_WITH_XE_HPG
        case HW::Xe_HPG: gpu_arch = compute::gpu_arch_t::xe_hpg; break;
#endif
#if DNNL_WITH_XE_HPC
        case HW::Xe_HPC: gpu_arch = compute::gpu_arch_t::xe_hpc; break;
#endif
