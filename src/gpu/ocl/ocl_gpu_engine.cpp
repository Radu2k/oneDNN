...
static const pd_create_f ocl_impl_list[] = {
        ...
        // Convolution
        INSTANCE(gen12hp_1x1_convolution_fwd_t),
        INSTANCE(gen12hp_bf16_convolution_bwd_weights_t),
        INSTANCE(gen12hp_1x1_convolution_fwd_t),
        INSTANCE(gen12hp_convolution_fwd_t),
        INSTANCE(gen12hp_convolution_bwd_data_t),
        INSTANCE(gen12lp_u8s8s32u8_1x1_convolution_fwd_t),
