...
#define C(tag, ... /* perm, inner_blks, inner_idxs */) \
    ...
    switch (tag) {
        ...
        C(ABcde2a2a8b8a2b, {0, 1, 2, 3, 4}, {2, 2, 8, 8, 2}, {0, 0, 1, 0, 1});
        C(ABcd2a2a8b8a2b, {0, 1, 2, 3}, {2, 2, 8, 8, 2}, {0, 0, 1, 0, 1});
        C(ABc2a2a8b8a2b, {0, 1, 2}, {2, 2, 8, 8, 2}, {0, 0, 1, 0, 1});
        C(aBCdef2b2b8c8b2c, {0, 1, 2, 3, 4, 5}, {2, 2, 8, 8, 2},
                {1, 1, 2, 1, 2});
        C(aBCde2b2b8c8b2c, {0, 1, 2, 3, 4}, {2, 2, 8, 8, 2}, {1, 1, 2, 1, 2});
        C(aBCd2b2b8c8b2c, {0, 1, 2, 3}, {2, 2, 8, 8, 2}, {1, 1, 2, 1, 2});
