...
#ifndef NGEN_GEN9_SIMPLE_SUM_KERNEL_F32_HPP
#define NGEN_GEN9_SIMPLE_SUM_KERNEL_F32_HPP

#include "common/c_types_map.hpp"
#include "ocl/jit_primitive_conf.hpp"
#include "ocl/ngen_jit_generator.hpp"

namespace dnnl {
namespace impl {
namespace ocl {

class ngen_gen9_simple_sum_kernel_f32_t : public ngen_jit_generator<gpu_gen9> {
public:
    ngen_gen9_simple_sum_kernel_f32_t() : ngen_jit_generator<gpu_gen9>() {
...
#endif // NGEN_GEN9_SIMPLE_SUM_KERNEL_F32_HPP
