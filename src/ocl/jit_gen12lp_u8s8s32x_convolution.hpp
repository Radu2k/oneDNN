...
struct jit_gen12lp_u8s8s32x_convolution_fwd_t : public primitive_impl_t {
    struct pd_t : public ocl_convolution_fwd_pd_t {
        ...
        DECLARE_COMMON_PD_T(
                "ocl:gen12lp", jit_gen12lp_u8s8s32x_convolution_fwd_t);
    ...
    jit_gen12lp_u8s8s32x_convolution_fwd_t(const pd_t *apd) : primitive_impl_t(apd) {
...
template <impl::data_type_t dst_type>
struct jit_gen12lp_u8s8s32x_convolution_bwd_data_t : public primitive_impl_t {
