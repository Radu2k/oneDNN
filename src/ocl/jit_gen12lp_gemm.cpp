...
status_t jit_gen12lp_gemm_t::launch_x8x8s32(
    ...
    jit_gen12lp_gemm_x8x8s32_kernel::get_unrolls(unroll_m, unroll_n);
    block_m = jit_gen12lp_gemm_driver_params::block_m;
    block_n = jit_gen12lp_gemm_driver_params::block_n;
    int kk = ((k + 3) & ~3);
...
status_t jit_gen12lp_gemm_t::launch_scale_x8x8s32(
    ...
    jit_gen12lp_gemm_scale_x8x8s32_kernel::get_unrolls(unroll_m, unroll_n);
...
status_t jit_gen12lp_gemm_t::execute(const exec_ctx_t &ctx) const {
    return execute_standard(ctx);
}

status_t jit_gen12lp_gemm_t::execute_standard(const exec_ctx_t &ctx) const {
    ...
    block_m = jit_gen12lp_gemm_driver_params::block_m;
    block_n = jit_gen12lp_gemm_driver_params::block_n;
    block_k = jit_gen12lp_gemm_driver_params::block_k;
