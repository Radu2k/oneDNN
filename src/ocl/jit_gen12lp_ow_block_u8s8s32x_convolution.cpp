...
status_t
jit_gen12lp_ow_block_u8s8s32x_convolution_fwd_t<dst_type>::execute_forward(
...
template struct jit_gen12lp_ow_block_u8s8s32x_convolution_fwd_t<u8>;
template struct jit_gen12lp_ow_block_u8s8s32x_convolution_fwd_t<s8>;
